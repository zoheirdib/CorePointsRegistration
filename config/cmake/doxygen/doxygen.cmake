option(BUILD_DOCUMENTATION "Build doxygen-based code documentation." OFF)
...
if(BUILD_DOCUMENTATION)
  ...
  set(DOXYGEN_SOURCE_DIR   "${ZD_ROOT_SOURCE_DIR}")
  set(DOXYGEN_INPUT_FILTER "${DOXYGEN_SCRIPT_DIR}/zd_doxy.pl")
  ...
  # level CMake file when ZDEngine is imported into other projects that use CMake.
  # When building ZDEngine as a stand-alone library, the CMAKE_MINIMUM_REQUIRED_VERSION
  # value is set from the top level CMakeList.txt file. When the ZDEngine
